...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        social_help: "Where to find me on the web.",
        reminder_help: "Just little reminders to keep going.",
        contact_help: "The contact page.",
        resume_help: "View my resume.",
        ...
        about_file_name: "An Appalachian child that can be found nestled at home with a Raspberry Pi and infuriated by lines of code. A passion for technology eventually became an inspiration, 'City Planet' and as well, turning Westsyvlanian mountaineers into Data Miners. Getting in trouble in high school for programming Ping-Pong in Visual Basics may be the only highlight in my tech career. I have completed Code Louisville, a developer bootcamp, and I am currently attending Kentucky State University to advance my career in Computer Science. I upload for-fun projects on "
        ...
        contact_file_name: "If you are an employer or client wishing to get in touch with me, you can e-Mail me.",
...
var main = (function () {
    ...
    var cmds = {
        ...
        ABOUT: {value: "about", help: configs.getInstance().about_help},
        SERVICE: {value: "service", help: configs.getInstance().service_help},
        SOCIAL: {value: "social", help: configs.getInstance().social_help},
        REMINDER: {value: "reminder", help: configs.getInstance().reminder_help},
        CONTACT: { value: "contact", help: configs.getInstance().contact_help},
    ...
    Terminal.prototype.handleCmd = function () {
        ...
        switch (cmdComponents[0]) {
            ...
            case cmds.ABOUT.value:
                this.about();
                break;
            case cmds.SERVICE.value:
                this.service();
                break;
            case cmds.SOCIAL.value:
                this.social();
                break;
            case cmds.REMINDER.value:
                this.reminder();
                break;
    ...
    Terminal.prototype.about = function () {
        var result = ".\n..\n" + configs.getInstance().about_file_name + "\n";
        for (var file in files.getInstance()) {
            results += file + "\n";
        }
        this.type(result.trim(), this.unlock.bind(this));
    ...
    Terminal.prototype.service = function() {
        var result = ".\n..\n" + configs.getInstance().service_file_name + "\n";
        for (var file in files.getInstance()) {
            results += file + "\n";
        }
        this.type(result.trim(), this.unlock.bind(this));
    ...
    Terminal.prototype.social = function () {
        var result = ".\n..\n" + configs.getInstance().social_file_name + "\n";
        for (var file in files.getInstance()) {
            results += file + "\n";
        }
        this.type(result.trim(), this.unlock.bind(this));
    ...
    Terminal.prototype.reminder = function () {
        var result = ".\n..\n" + configs.getInstance().reminder_file_name + "\n";
        for (var file in files.getInstance()) {
            results += file + "\n";
        }
        this.type(result.trim(), this.unlock.bind(this));
    ...
    Terminal.prototype.contact = function () {
        var result = ".\n..\n" + configs.getInstance().contact_file_name + "\n";
        for (var file in files.getInstance()) {
            results += file + "\n";
        }
        this.type(result.trim(), this.unlock.bind(this));
